...
resource "aws_cloudwatch_dashboard" "webui_dashboard" {
  dashboard_name = "WebUI-HorizontalScaling"
...
resource "aws_cloudwatch_metric_alarm" "alb_high_response_time" {
  alarm_name          = "webui-alb-high-response-time"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
...
resource "aws_cloudwatch_metric_alarm" "redis_high_cpu" {
  alarm_name          = "webui-redis-high-cpu"
  comparison_operator = "GreaterThanThreshold"
  evaluation_periods  = "2"
  metric_name         = "CPUUtilization"
